  ...
  return (
    <footer className={styles.footer}>
      ...
      <div className={styles.ref} {...animatedItem[1]}>
        <span>by.</span>
        <a
          href='https://iconape.com/'
          target='_blank'
          rel='noreferrer'
          className={styles.link}
        >
          <img
            src={require('static/images/footer_ape.svg').default}
            alt='iconape'
          />
        </a>
        <a
        ...
        >
          <img
            src={require('static/images/footer_fla.svg').default}
            alt='flaticon'
          />
        </a>
        <a
        ...
        >
          <img
            src={require('static/images/footer_freepik.svg').default}
            alt='freepik'
          />
        </a>
      </div>
      <div className={styles.box}>
        <p className={styles.copyright}>
          &copy; 2021 Junhyung Park. All rights reserved.
        </p>
